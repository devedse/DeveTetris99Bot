...
#define __USB_H__
	...
	/* Includes: */
		#include "LUFA/Drivers/USB/Core/USBTask.h"
		...
		#include "LUFA/Drivers/USB/Core/USBInterrupt.h"
			...
			#include "LUFA/Drivers/USB/Core/Host.h"
			#include "LUFA/Drivers/USB/Core/Pipe.h"
			#include "LUFA/Drivers/USB/Core/HostStandardReq.h"
			#include "LUFA/Drivers/USB/Core/PipeStream.h"
		#endif
			...
			#include "LUFA/Drivers/USB/Core/EndpointStream.h"
		#endif

		#if defined(USB_CAN_BE_BOTH) || defined(__DOXYGEN__)
			#include "LUFA/Drivers/USB/Core/OTG.h"
		#endif

		#include "LUFA/Drivers/USB/Class/AndroidAccessoryClass.h"
		#include "LUFA/Drivers/USB/Class/AudioClass.h"
		...
		#include "LUFA/Drivers/USB/Class/PrinterClass.h"
		#include "LUFA/Drivers/USB/Class/RNDISClass.h"
		#include "LUFA/Drivers/USB/Class/StillImageClass.h"
